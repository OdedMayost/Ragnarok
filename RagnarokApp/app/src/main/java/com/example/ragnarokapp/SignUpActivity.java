...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent signup_activity = getIntent();
        IP = signup_activity.getStringExtra("IP");
        Log.d(TAG, "IP = " + IP);
        Key = signup_activity.getStringExtra("Key").getBytes();
    ...
    public void sign_up(View v){
        ...
        String phone_number = ((TextView) findViewById(R.id.Phone_Number)).getText().toString();
        String message = "SGNUP~" + username + "~" + password + "~" + name + "~" + phone_number;
